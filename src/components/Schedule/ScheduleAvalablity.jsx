...
const ScheduleAvalablity = ({ initialSchedule, weekDays, teachingSlots }) => {
  ...
  const renderIcon = (weekDayId, slotId) => {
    const isScheduled = schedule.some(day => day.weekDayIds === weekDayId && day.teachingSlotIds.includes(slotId));
    return isScheduled ? <CheckOutlined style={{ color: 'green' }} /> : <MinusOutlined />;
  };
...
export default ScheduleAvalablity;
